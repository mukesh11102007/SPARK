...
// Transform JSX source into browser-runnable JS code using local bundled Babel
  ...
  <script>
    (function() {
      ...
      try {
        ...
        // Execute pre-transpiled clean JS code directly
        var runner = new Function(rawCode);
        runner();
